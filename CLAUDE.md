...
- **Engine routing**: `AudioTranscriptionManager` routes between Parakeet (FluidAudio) and WhisperKit based on user settings and transcription results. All speech-to-text is local; there is no cloud fallback.
